...
import br.gov.ce.sps.template.api.request.DepartamentoRequest;
import br.gov.ce.sps.template.api.response.DepartamentoResponse;
import br.gov.ce.sps.template.domain.model.Departamento;
import br.gov.ce.sps.template.domain.service.departamento.*;
