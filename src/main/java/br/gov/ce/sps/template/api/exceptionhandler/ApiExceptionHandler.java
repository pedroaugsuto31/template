package br.gov.ce.sps.template.api.exceptionhandler;

import br.gov.ce.sps.template.domain.exception.CpfJaCadastradoException;
import br.gov.ce.sps.template.domain.exception.EntidadeEmUsoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleValidationInternal(MethodArgumentNotValidException ex,
                                                            HttpHeaders headers,
                                                            HttpStatusCode status,
                                                            WebRequest request,
